...
<div class="login">
    <Row justify="center" align="middle" @keydown.enter.native="submitRegist" style="height:100%">
        <div class="loginUp">
            <div class="loginLeft">
                <img src="../assets/login/LZUxiaohui.png" alt="" srcset="">
                <span class="line"></span>
                <span class="title">毕业论文（设计）选题系统</span>
            </div>
        </div>
        <div class="loginMiddle">
            <div class="login-background">
                ...
                <div class="loginRight">
                    <div class="loginText">欢迎注册兰州大学毕业论文（设计）选题系统</div>
                    <Row v-if="!socialLogining" class="loginRow">
                        <Form ref="usernameLoginForm" :model="form" :rules="rules" class="form" style="width:100%">
                            <FormItem prop="username" class="loginInput">
                                <Row>
                                    <Input v-model="form.username" @input="limitLength" size="large" clearable placeholder="校园卡号（登录唯一标识）" autocomplete="off">
                        ...
                        <Row class="row-r">
                            <Button class="login-btn" type="primary" size="large" :loading="loading" @click="submitRegist" long>
                                <span v-if="!loading" style="letter-spacing:10px; font-weight:bold">注册</span>
        ...
        <div class="loginDown">
            ...
            <p>
                ...
                <a target="_blank" href="https://beian.miit.gov.cn" style="color:#848585">ICP备案 甘ICP备XXXXXXXX号</a>
                <a target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=XXXXXXXXXXXXXX号">
                    ...
                    <p style="display:inline-block;color:#848585">甘公网安备 XXXXXXXXXXXXXX号</p>
                </a>
            </p>
        </div>
    </Row>
...
export default {
    ...
    methods: {
        limitLength() {
            // 限制数字的长度为12
            // if (this.inputNumber.length > 12) {
            //     this.inputNumber = this.inputNumber.replace(/\D/g, '').slice(0, 12);
            // }      
        },
        getCaptchaImg() {
