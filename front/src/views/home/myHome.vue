    ...
    <Card>
        ...
        <Form ref="userForm" :model="userForm" :label-width="90" label-position="left">
            ...
            <Row :gutter="16">
                ...
                <Col :span="12">
                <FormItem label="专业" prop="departmentTitle">
            ...
            <Row :gutter="16">
                <Col :span="12">
                <FormItem label="所在城市" prop="username">
        ...
        <Row :gutter="16">
            ...
            <List header="---" footer="---" border>
                <ListItem v-for="(item, index) in addMenuTempList" :key="index">
                    {{ item.title }}
                    <Button @click="deleteOneMenu(item)" type="error" shape="circle" icon="md-trash" size="small" style="margin-Left:20px;"></Button>
                </ListItem>
            </List>
            </Col>
            <Col span="12">
