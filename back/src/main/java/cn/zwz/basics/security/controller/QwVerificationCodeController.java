...
import cn.zwz.basics.security.utils.WxNoticeUtils;
...
public class QwVerificationCodeController {
    ...
    public Result<Object> sendVerificationCode(@RequestParam String jobNumber) {
         ...
         * 这里需要实现判断发给谁的业务逻辑
         */
        WxNoticeUtils.sendTuWenMessage("zwz", "OA登陆验证","验证码 " + verificationCode + "，1分钟后失效","https://gitee.com/yyzwz","https://bkimg.cdn.bcebos.com/pic/37d12f2eb9389b503a80d4b38b35e5dde6116ed7", WeiChatUtils.getToken());
